    ...
    public function getSubmenu($id) {
		...
		foreach ($query->rows as $row) {
			...
			if(isset($content['image']['link']) && $content['image']['link']) {
                ...
                $images['link'] = '<img class="lazyload" data-sizes="auto" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="'.$link.'" alt="" style="width: 100%;">';
            ...
            if(isset($content['product']['id'])) {
                $product = $this->model_catalog_product->getProduct($content['product']['id']);
                if(is_array($product)) {
            ...
            if(isset($product['image'])) {
                $product_image = $this->model_tool_image->resize($product['image'], 150, 150);
            } else {
                $product_image = false;
            }
            $output[] = array(
