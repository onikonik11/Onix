	...
	public function index($setting) {
		...
		if($listCategory_son != null){
			...
			if($is_ajax && isset($_POST['is_ajax_super_category']) && $_POST['is_ajax_super_category'] ){
				...
				if (file_exists(DIR_TEMPLATE . $this->config->get('theme_default_directory') . '/template/extension/module/so_super_category/default.twig')) {
					include(DIR_TEMPLATE .$this->config->get('theme_default_directory') . '/template/extension/module/so_super_category/default_items.tpl');
				} else {
					include(DIR_TEMPLATE .'default/template/extension/module/so_super_category/default_items.tpl');
				}
