...
class ControllerExtensionModuleSoquickview extends Controller {
	...
	public function index($setting) {
		...
		return $this->load->view('extension/module/so_quickview/default', $data);
	}
	...
	public function detail() {
		...
		if ($product_info) {
			...
			if (isset($product_description_short)) $data['description_short']  = html_entity_decode(strip_tags($product_description_short), ENT_QUOTES, 'UTF-8');
			//=====
			...
			$this->response->setOutput($this->load->view('extension/module/so_quickview/product', $data));
		} else {
			$url = '';
