...
class ControllerExtensionModuleSolistingtabs extends Controller {
	public function index($setting) {
		...
		if($is_ajax && isset($_POST['is_ajax_listing_tabs']) && $_POST['is_ajax_listing_tabs']){
			...
			$url_items_tdd = $this->config->get('theme_default_directory') . '/template/extension/module/so_listing_tabs/default_items.twig';
			...
			$twig = new Twig_Environment($loader, array('cache'=>DIR_CACHE.'so/ListingTabs/'));
			$data_template = array(
				'objlang'				=> $objlang,
				'type_show' 			=> $type_show,
