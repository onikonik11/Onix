...
class ControllerExtensionModuleSonewlettercustompopup extends Controller {
	...
	public function index() {
		...
		$data['layouts'] = array(
			...
			'layout_home2' 	=> $this->language->get('value_layout2'),
			'layout_home4' 	=> $this->language->get('value_layout4'),
			'layout_home5' 	=> $this->language->get('value_layout5'),
			'layout_popup' 		=> $this->language->get('value_layout_popup'),
		);
