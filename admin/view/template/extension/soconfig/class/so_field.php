...
class So_Fields {
	...
	*/
	...
	public function field_radio($key,$name,$options) {
		$field = '';
		$radios = array();
		$names	= $key.'['.$name.']';
		
		$selected	= isset($this->config[$key][$name]) ? $this->config[$key][$name] : '';
		
		$radios[] = '<div class="btn-group btn-toggle" data-toggle="buttons">';
	...
	*/
	 ...
	 *     (name) - string value of the name
	*/
	function field_text($nameconfig,$element,$placeholder=null){
		$config = $this-> config;
		$names	= $nameconfig.'['.$element.']';
	...
	function field_addimage($nameconfig,$element){
		$config = $this-> config;
		$names	= $nameconfig.'['.$element.']';
		$values	= isset($config[$nameconfig][$element]) ? $config[$nameconfig][$element] : '';
		...
		$fieldimage ='<a href="" id="thumb-'.$element.'" data-toggle="image" class="img-thumbnail">';
	...
	function field_select($nameconfig,$element,$element_array,$element_class =''){
		$config = $this-> config;
		$names	= $nameconfig.'['.$element.']';
		$values	= isset($config[$nameconfig][$element]) ? $config[$nameconfig][$element] : '';
	...
	function field_langHori($languages,$nameconfig,$element,$size=null){
		$config = $this-> config;
